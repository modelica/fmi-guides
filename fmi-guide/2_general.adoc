...
NOTE: Please note that the FMI Cross-Checking repository https://github.com/modelica/fmi-cross-check is archived and not longer used. This has been replaced by the compatibility information described above.
...
* FMPy (https://github.com/CATIA-Systems/FMPy) and fmusim (from the Reference FMUs, https://github.com/modelica/reference-fmus) can be used to simulate and validate FMUs.
* <<VDMCheck>> validates FMUs against a formal model of the FMI specification

NOTE: Please note that the FMU Compliance Checker <<FMUCC>> is archived and no longer maintained.
