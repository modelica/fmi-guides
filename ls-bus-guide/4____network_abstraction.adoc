...
It should be clear at this point that this simple implementation is compromised by https://modelica.github.io/fmi-ls-bus/main/#low-cut-selecting-tx-variables[limitations in bus simulation].
